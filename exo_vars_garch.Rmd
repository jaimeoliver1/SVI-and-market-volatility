...
# Format numbers
options(scipen = 50)
df <- read_csv('C:/Users/Jaime/Dropbox/master Economics/econometrics2/project/data/GARCH_model.csv')
# df <- read_csv('C:/Users/jaime.oliver/Dropbox/master Economics/econometrics2/project/data/GARCH_model.csv')
# df = df %>%
...
```{r}
write.csv(garch_results, file = "C:/Users/Jaime/Dropbox/master Economics/econometrics2/project/data/GARCH_results.csv")
# write.csv(garch_results, file = "C:/Users/jaime.oliver/Dropbox/master Economics/econometrics2/project/data/GARCH_results.csv")
```
